...
import { ImportUsersMethodPossiblities, ImportUsersMethodPossiblitiesType } from '../../utils/utils';
    ...
    <Flex direction='column'>
      ...
      <Flex mt={2}>
        <Text mr={2} mb={5} fontSize='xl'>
          Import {signInMethod === ImportUsersMethodPossiblities.IMPORT_STAFF ? 'staff' : ' staff and students'}
        </Text>
        <Tooltip
          hasArrow
