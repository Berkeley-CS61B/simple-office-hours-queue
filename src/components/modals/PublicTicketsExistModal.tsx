...
const PublicTicketsExistModal = (props: PublicTicketsExistModalProps) => {
  ...
  useEffect(() => {
    const publicTicketsExistModalClosed = sessionStorage.getItem('publicTicketsExistModalClosed');
  ...
  return (
    <Modal isOpen={isModalOpen} onClose={handleModalClose} size='4xl'>
      ...
      >
        ...
        <ModalBody>
          <Text mb={2}>
            Joining a public ticket will allow staff members to help you for longer time. Please note that these are for
